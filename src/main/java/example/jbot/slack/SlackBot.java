...
public class SlackBot extends Bot {
    ...
    /**
     * Tokens to connect with bluemix services.
     * @param bmUrl
     * @param bmUsername
     * @param bmPassword
     * @param bmWorkspaceID
    ...
    public Bot getSlackBot() {
     ...
     /**
     * Connecting and communicating with Watson service.
     */
    
    ConversationService convService = new ConversationService(ConversationService.VERSION_DATE_2017_02_03, "5f7cc9a3-a091-4cfb-afa7-95436fb0a12b", "Ma0yydgnZYos");
    
    MessageRequest.Builder bmBuilder = new MessageRequest.Builder();
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
    		...
    		MessageRequest bmInput = bmBuilder.inputText(event.getText()).build();
        MessageResponse bmResponse = convService.message(bmWorkspaceID, bmInput).execute();
        reply(session, event, new Message(bmResponse.getTextConcatenated(" ")));
    }
